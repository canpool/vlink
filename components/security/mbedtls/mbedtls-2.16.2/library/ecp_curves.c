...
/*
 * Domain parameters for FRP256V1
 */
#if defined(MBEDTLS_ECP_DP_FRP256V1_ENABLED)
static const mbedtls_mpi_uint FRP256V1_p[] = {
    BYTES_TO_T_UINT_8( 0x03, 0x9C, 0x6E, 0xD8, 0x53, 0xF3, 0xFC, 0xE8 ),
    BYTES_TO_T_UINT_8( 0x6D, 0xCA, 0xC8, 0xAB, 0xBC, 0xAD, 0x61, 0x39 ),
    BYTES_TO_T_UINT_8( 0x5B, 0x43, 0x42, 0xCE, 0xE8, 0x6D, 0x12, 0x10 ),
    BYTES_TO_T_UINT_8( 0x8F, 0xD5, 0x3A, 0x0B, 0x8C, 0x17, 0xFD, 0xF1 ),
};
static const mbedtls_mpi_uint FRP256V1_a[] = {
    BYTES_TO_T_UINT_8( 0x00, 0x9C, 0x6E, 0xD8, 0x53, 0xF3, 0xFC, 0xE8 ),
    BYTES_TO_T_UINT_8( 0x6D, 0xCA, 0xC8, 0xAB, 0xBC, 0xAD, 0x61, 0x39 ),
    BYTES_TO_T_UINT_8( 0x5B, 0x43, 0x42, 0xCE, 0xE8, 0x6D, 0x12, 0x10 ),
    BYTES_TO_T_UINT_8( 0x8F, 0xD5, 0x3A, 0x0B, 0x8C, 0x17, 0xFD, 0xF1 ),
};
static const mbedtls_mpi_uint FRP256V1_b[] = {
    BYTES_TO_T_UINT_8( 0x3F, 0xB7, 0x7B, 0x7B, 0x96, 0xED, 0x75, 0x30 ),
    BYTES_TO_T_UINT_8( 0x80, 0xA1, 0xB1, 0xE4, 0x9A, 0x0C, 0xEC, 0xDF ),
    BYTES_TO_T_UINT_8( 0x0F, 0xC0, 0x44, 0x4A, 0x75, 0xBA, 0x4A, 0x0D ),
    BYTES_TO_T_UINT_8( 0x30, 0xA9, 0x28, 0x54, 0xCA, 0x3F, 0x35, 0xEE ),
};
static const mbedtls_mpi_uint FRP256V1_gx[] = {
    BYTES_TO_T_UINT_8( 0xFF, 0x5C, 0x8F, 0xD9, 0x2D, 0x7A, 0xC9, 0x64 ),
    BYTES_TO_T_UINT_8( 0x01, 0xB7, 0x98, 0xAF, 0xDC, 0xD2, 0x27, 0x8C ),
    BYTES_TO_T_UINT_8( 0x95, 0x23, 0xD4, 0x49, 0x47, 0x3D, 0x18, 0x31 ),
    BYTES_TO_T_UINT_8( 0xEB, 0x39, 0xC1, 0x56, 0xC3, 0xD4, 0xB3, 0xB6 ),
};
static const mbedtls_mpi_uint FRP256V1_gy[] = {
    BYTES_TO_T_UINT_8( 0xFB, 0x2C, 0x06, 0x54, 0x15, 0x5A, 0x11, 0x83 ),
    BYTES_TO_T_UINT_8( 0xE1, 0xC9, 0xE4, 0xE8, 0x07, 0xC3, 0x01, 0x27 ),
    BYTES_TO_T_UINT_8( 0x8C, 0xEF, 0xEC, 0xF3, 0xF0, 0x71, 0x92, 0x1F ),
    BYTES_TO_T_UINT_8( 0x91, 0x04, 0xB2, 0xC8, 0xF7, 0xE0, 0x42, 0x61 ),
};
static const mbedtls_mpi_uint FRP256V1_n[] = {
    BYTES_TO_T_UINT_8( 0xE1, 0x55, 0xD6, 0xC6, 0x59, 0xD4, 0xFD, 0x1F ),
    BYTES_TO_T_UINT_8( 0x94, 0xBF, 0xD2, 0x40, 0xE1, 0x67, 0xDC, 0x53 ),
    BYTES_TO_T_UINT_8( 0x5B, 0x43, 0x42, 0xCE, 0xE8, 0x6D, 0x12, 0x10 ),
    BYTES_TO_T_UINT_8( 0x8F, 0xD5, 0x3A, 0x0B, 0x8C, 0x17, 0xFD, 0xF1 ),
};
...
#if defined(MBEDTLS_ECP_DP_FRP256V1_ENABLED)
        case MBEDTLS_ECP_DP_FRP256V1:
            return( LOAD_GROUP_A( FRP256V1 ) );
#endif /* MBEDTLS_ECP_DP_FRP256V1_ENABLED */
