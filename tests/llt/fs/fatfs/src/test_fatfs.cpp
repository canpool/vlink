...
extern "C" {
extern int mock_fatfs_init(void);
extern int mock_fatfs_exit(int drive);
}
...
protected:
    void SetUp() {
        s_drive = mock_fatfs_init();
	};

	void TearDown() {
	    mock_fatfs_exit(s_drive);
	};
};
...
{
/*
    d---------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/1
    ----------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/1/1.TXT
    d---------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/.2
    ----------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/.2/2.TXT
    d---------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/3
    d---------   0 root     root             0 Wed Dec 31 16:00:00 1969 d/3/3_1
